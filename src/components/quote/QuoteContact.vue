  ...
  <div class="appt-contact">
    <div class="vehicle-info-area">
      ...
      <div class="vehicle-sel-area" v-if="service_type === 'residential'">
        <div class="sel-area sel-residential" :class="{ activated: active_residential }">
          <b-form-select
            class="custom-select-vehicle"
            @change="changeSelect"
      ...
      <div class="vehicle-sel-area" v-if="service_type === 'commercial'">
        <div class="sel-area sel-building" :class="{ activated: active_building }">
          <b-form-select
            class="custom-select-vehicle"
            @change="changeSelect"
    ...
    <div class="person-info-area">
      ...
      <b-form>
        ...
        <div
          class="address-form"
          v-if="this.$store.state.quote.service.off_site"
        >
...
export default {
  ...
  mounted() {
    this.reset();
    var load_contact = this.$store.state.quote.contact;
  ...
  computed: {
    ...
    options_model() {
      ...
      console.log(this.$store.state.carMakes);
      var models = [];
      if (!this.sel_make) {
    ...
    validation() {
      ...
      if (this.form.first_name !== "") {
        ...
        if (this.form.last_name !== "") {
          ...
          if (!error && this.$store.state.quote.service.off_site) {
            if (
              this.address.street !== "" &&
              this.address.city !== "" &&
              this.address.state &&
          ...
          if (!error) {
            eventBus.$emit("isChangedQuoteValidation", true);
            this.$store.commit("setQuote", { type: "contact", data: param });
          } else {
            eventBus.$emit("isChangedQuoteValidation", false);
          }
        } else {
